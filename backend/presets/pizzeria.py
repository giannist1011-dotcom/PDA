...
PRESET = {
    ...
    "stock_items": {
        ...
        "Αναψυκτικά/Ποτά": ["Αναψυκτικό cola 330ml", "Πορτοκαλάδα", "Νερό 500ml", "Νερό 1,5L", "Μπύρα", "Κρασί"],
        "Συσκευασίες": ["Κουτιά πίτσας 28cm", "Κουτιά πίτσας 32cm", "Σακούλες 35άρες", "Σακούλες 45άρες", "Χαρτοπετσέτες", "Πλαστικά μαχαιροπίρουνα"],
    },
}
