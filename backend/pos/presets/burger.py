...
PRESET = {
    ...
    "stock_items": {
        "Κρέατα/Μπιφτέκια": ["Μπιφτέκι μοσχαρίσιο 150γρ", "Μπιφτέκι κοτόπουλο", "Φιλέτο κοτόπουλο", "Μπέικον", "Λουκάνικο"],
        "Ψωμάκια": ["Ψωμάκια brioche", "Ψωμάκια με σουσάμι", "Ψωμάκια ολικής", "Mini ψωμάκια"],
        "Τυριά/Αλλαντικά": ["Τσένταρ σε φέτες", "Γκούντα", "Μπλε τυρί", "Ζαμπόν", "Μπέικον σε φέτες"],
        "Λαχανικά": ["Ντομάτες", "Μαρούλι iceberg", "Κρεμμύδια", "Αγγουράκια πίκλες", "Πιπεριές τσίλι"],
        "Σως": ["Κέτσαπ", "Μαγιονέζα", "Μουστάρδα", "Σως μπάρμπεκιου", "Σως τσένταρ", "Σως μπέργκερ"],
        "Κατεψυγμένα": ["Πατάτες τηγανητές", "Onion rings", "Nuggets", "Μοτσαρελάκια"],
        "Συσκευασίες": ["Κουτιά μπέργκερ", "Χάρτινα σκαφάκια", {"name": "Σακούλες", "variants": ["35άρες", "45άρες"]}, "Χαρτοπετσέτες", "Λαδόκολλα"],
        "Αναψυκτικά": ["Αναψυκτικό cola 330ml", "Πορτοκαλάδα", "Νερό 500ml", "Παγωμένο τσάι", "Μπύρα"],
    },
}
