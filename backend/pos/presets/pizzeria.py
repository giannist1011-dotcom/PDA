...
PRESET = {
    ...
    "stock_items": {
        "Αλεύρι/Ζύμη": ["Αλεύρι δυνατό", "Μαγιά", "Έτοιμη ζύμη", "Σιμιγδάλι", "Ελαιόλαδο"],
        "Τυριά": ["Μοτσαρέλα τριμμένη", "Γκούντα", "Παρμεζάνα", "Φέτα", "Κασέρι"],
        "Αλλαντικά": ["Ζαμπόν", "Μπέικον", "Πεπερόνι", "Λουκάνικο", "Γαλοπούλα"],
        "Λαχανικά": ["Ντομάτες", "Πιπεριές", "Μανιτάρια", "Κρεμμύδια", "Ελιές", "Ρόκα", "Καλαμπόκι"],
        "Σάλτσες": ["Σάλτσα ντομάτας", "Κέτσαπ", "Μαγιονέζα", "Μουστάρδα", "Σως μπάρμπεκιου", "Ρίγανη"],
        "Αναψυκτικά/Ποτά": ["Αναψυκτικό cola 330ml", "Πορτοκαλάδα", {"name": "Νερό", "variants": ["500ml", "1,5L"]}, "Μπύρα", "Κρασί"],
        "Συσκευασίες": [{"name": "Κουτιά πίτσας", "variants": ["28cm", "32cm"]}, {"name": "Σακούλες", "variants": ["35άρες", "45άρες"]}, "Χαρτοπετσέτες", "Πλαστικά μαχαιροπίρουνα"],
    },
}
