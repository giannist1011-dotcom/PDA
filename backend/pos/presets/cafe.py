...
PRESET = {
    ...
    "stock_items": {
        "Καφές": ["Espresso blend", "Καφές φίλτρου", "Ελληνικός καφές", "Στιγμιαίος καφές", "Ντεκαφεϊνέ"],
        "Γάλα": ["Φρέσκο γάλα πλήρες", "Φρέσκο γάλα light", "Γάλα αμυγδάλου", "Γάλα βρώμης", "Γάλα εβαπορέ"],
        "Σιρόπια/Γεύσεις": ["Σιρόπι βανίλια", "Σιρόπι καραμέλα", "Σιρόπι φουντούκι", "Σοκολάτα ρόφημα", "Κανέλα"],
        "Αναλώσιμα (ποτήρια/καλαμάκια)": ["Ποτήρια 8oz", "Ποτήρια 12oz", "Ποτήρια 16oz", "Καπάκια ποτηριών", "Καλαμάκια", "Αναδευτήρες", "Χαρτοπετσέτες", "Σακούλες μεταφοράς"],
        "Σνακ/Τοστ": ["Ψωμί τοστ", "Τυρί τοστ", "Ζαμπόν", "Κρουασάν", "Σάντουιτς", "Πατατάκια"],
        "Γλυκά": ["Σοκολατόπιτα", "Cheesecake", "Μπισκότα", "Κέικ", "Ζάχαρη & γλυκαντικά"],
        "Καθαριστικά": ["Απορρυπαντικό πιάτων", "Καθαριστικό μηχανής espresso", "Χλωρίνη", "Χαρτί κουζίνας", "Σακούλες σκουπιδιών"],
    },
}
