...
from shared.core import db, get_current_user, require_owner, require_manager, require_feature, actor_name
from pos.orders import Order, OrderItem, compute_next_order_number
from shared.geocoding import clear_cache as clear_geocode_cache
...
async def update_store_details(body: StoreDetailsIn, user: dict = Depends(require_feature("settings", require_owner))):
    ...
    if (
        ...
        await clear_geocode_cache(user["id"])
    return fields
