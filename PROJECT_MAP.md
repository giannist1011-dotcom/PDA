...
- POST /orders/{oid}/cancel → cancel_order @491
- DELETE /orders/{oid} → delete_order @516
- GET /customers → list_customers @529 — Aggregate customers from phone/delivery orders, grouped by phone
### promo.py
...
- OrderPanel.jsx (447 γρ): OrderPanel@40
...
- ProtectedRoute.jsx (22 γρ): ProtectedRoute@9
