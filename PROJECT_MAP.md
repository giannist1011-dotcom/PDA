...
- GET /admin/shops → admin_list_shops @104
- GET /admin/shops/{uid} → admin_shop_detail @180
- POST /admin/shops/{uid}/profiles/{pid}/reset-pin → admin_reset_profile_pin @217 — Επαναφορά PIN προφίλ από τον διαχειριστή πλατφόρμας: προσωρινό…
- PATCH /admin/shops/{uid} → admin_update_shop @272
- DELETE /admin/shops/{uid} → admin_delete_shop @297
- GET /admin/subscriptions/expiring → admin_expiring_subscriptions @312 — Συνδρομές/δοκιμές που λήγουν στις επόμενες 7 ημέρες (για…
- GET /admin/leads → admin_leads @334
### ai.py
...
- fleet_accounts: routers/fleet.py, server.py
- fleet_counters: routers/fleet.py, server.py
- fleet_events: routers/fleet.py, server.py
- fleet_members: routers/fleet.py, server.py
- fleet_orders: routers/fleet.py, server.py
- fleet_teams: routers/fleet.py, server.py
...
- users: core.py, routers/admin.py, routers/auth.py, routers/billing.py, routers/fleet.py, routers/menu.py, routers/onboarding.py, routers/orders.py, routers/promo.py, routers/public_menu.py, routers/tables.py, server.py
...
- admin-shops/ShopModal.jsx (407 γρ): ShopModal@23
