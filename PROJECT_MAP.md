...
### admin.py
- GET /admin/ping → admin_ping @50 — Ελαφρύς έλεγχος του admin password για το login…
- GET /admin/overview → admin_overview @58
- GET /admin/shops → admin_list_shops @106
- GET /admin/shops/{uid} → admin_shop_detail @183
- POST /admin/shops/{uid}/profiles/{pid}/reset-pin → admin_reset_profile_pin @220 — Επαναφορά PIN προφίλ από τον διαχειριστή πλατφόρμας: προσωρινό…
- PATCH /admin/shops/{uid} → admin_update_shop @275
...
### admin_fleet.py
- GET /admin/fleet → admin_list_fleet @44
- GET /admin/fleet/{uid} → admin_fleet_detail @105
- PATCH /admin/fleet/{uid} → admin_update_fleet @152
- DELETE /admin/fleet/{uid} → admin_delete_fleet @205
- POST /admin/demos → admin_create_demo @350 — Demo λογαριασμός από τον admin — μαγαζί (με…
- POST /admin/demos/{uid}/reset → admin_reset_demo @407 — Επαναφορά demo στην αρχική seeded κατάσταση — τα…
- DELETE /admin/demos/{uid} → admin_delete_demo @440 — Οριστική διαγραφή demo λογαριασμού (χωρίς επιβεβαίωση ονόματος —…
### ai.py
...
- admin_audit: routers/admin.py, server.py
...
- AdminFleet.jsx (48 γρ): AdminFleet@8
...
- AdminShops.jsx (52 γρ): AdminShops@12
...
- admin-fleet/FleetModal.jsx (401 γρ): FleetModal@22
...
- admin-shops/ShopModal.jsx (434 γρ): ShopModal@24
...
- AdminShell.jsx (185 γρ): useAdminPw@23, AdminShell@39
