...
- GET /orders/{oid} → get_order @465
- POST /orders/{oid}/activate → activate_order @475 — Move a scheduled order to active (fired /…
- POST /orders/{oid}/cancel → cancel_order @495
- DELETE /orders/{oid} → delete_order @522
- GET /customers → list_customers @537 — Aggregate customers from phone/delivery orders, grouped by phone
### promo.py
...
- AppShell.jsx (504 γρ): BetaBadge@86, DemoBanner@110, AppShell@153
