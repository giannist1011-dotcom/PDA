  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && commitAndClose()}>
      <DialogContent
        ...
        className="max-w-md bg-[#2A0E14] border-[#723645] text-white"
      >
        <DialogHeader>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-[#3D1620] border border-[#723645] rounded-lg">
            ...
            <div className="flex items-center justify-between">
              <button
                ...
                className="w-16 h-16 rounded-lg bg-[#2A0E14] border border-[#723645] hover:border-flame text-white flex items-center justify-center active:scale-95 transition-transform"
              >
          ...
          {hasOptions && (
            <Button
              ...
              className="w-full h-12 bg-[#3D1620] border border-[#723645] hover:border-flame text-white font-bold flex items-center justify-center gap-2"
            >
