      ...
      <DialogContent className="max-w-lg bg-[#2A0E14] border-[#723645] text-white max-h-[85vh] overflow-y-auto" data-testid="bulk-group-dialog">
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <Button
            ...
            className="w-full h-10 bg-transparent border border-dashed border-[#6B3345] hover:border-flame text-neutral-400 hover:text-white text-xs"
          >
...
export default function BulkActionsBar({ selected, categories, onDone, onClear }) {
  ...
  return (
    <>
      <div
        className="sticky bottom-4 z-30 mt-4 p-3 bg-[#3D1620] border border-flame/40 rounded-xl shadow-2xl shadow-black/40 flex flex-wrap items-center gap-2"
