...
import { STATUS_META, ageColorClass, minutesSince, mapsUrl, PROBLEM_LABELS } from "./utils";
...
export default function OrderCard({ order, drivers, city, onChanged }) {
  ...
  // διάρκεια μέχρι την παράδοση (στατική, ουδέτερο χρώμα).
  const mins = active
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="font-bold shrink-0">#{order.number}</span>
      ...
      <div className="mt-2 truncate text-neutral-200 font-semibold">{order.pickup_name}</div>
      <a
