    ...
    <AppShell title="Τραπέζια">
      <main className="flex-1 overflow-y-auto p-4 md:p-8 max-w-[1200px] mx-auto w-full">
        ...
        {loading && !state ? (
          ...
          <div className="text-neutral-500 py-16 text-center bg-[#1A1A1A] border border-[#333] rounded-lg px-6">
      ...
      {editorOpen && (
        ...
        >
          <div className="bg-[#1A1A1A] border border-[#333] rounded-lg w-full max-w-md max-h-[85vh] flex flex-col p-5">
