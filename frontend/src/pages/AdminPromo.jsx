...
import { Plus, Trash2, Power, Store, RefreshCw, ChevronDown, ChevronUp } from "lucide-react";
import {
  apiAdminListPromos,
  apiAdminCreatePromo,
  apiAdminTogglePromo,
...
function PromoContent() {
  ...
  const load = async () => {
    const data = await apiAdminListPromos(pw);
    setCodes(data);
  };
...
export default function AdminPromo() {
  return (
    <AdminShell title="Εκπτωτικοί κωδικοί" subtitle="Κωδικοί για το wizard εγγραφής">
      <PromoContent />
    </AdminShell>
  );
}
